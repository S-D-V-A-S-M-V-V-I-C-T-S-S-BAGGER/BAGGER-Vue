...
<template>
  <div id="wrapper" class="flex flex-col items-center mx-5 my-5 gap-y-10">
    ...
    <BaggerButton icon="fa-solid fa-forward" :faded="emptySelected" :isPrimary=false customStyling="w-[40vw] md:w-[15vw]"
    ...
    <div id="occasions" class="flex flex-col items-center gap-y-5">
      <div id="new-occasion">
        <BaggerButton icon="fa-solid fa-plus" :isPrimary=false customStyling="w-[40vw] md:w-[20vw]" @click="popup = true">
          Nieuwe Gelegenheid
        </BaggerButton>
      </div>
